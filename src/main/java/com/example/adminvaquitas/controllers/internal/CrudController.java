package com.example.adminvaquitas.controllers.internal;
...
public abstract class CrudController<T extends AuditModel> implements ICrudController<T> {
    ...
    public ResponseEntity<?> create(@RequestBody T t) throws HttpException {
        ...
        return ResponseHandler.generateResponse("Data created", HttpStatus.CREATED, dataCreated);
    }
    ...
    @Override
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable String id, @RequestBody T t) throws HttpException {
